...
class Document(object):
    ...
    def _process_mentions(self, mentions_spans, utterance_index, n_sents, speaker):
        ...
        '''
        processed_spans = sorted((m for m in mentions_spans), key=lambda m: (m.root.id, m.start))
    ...
    def set_mentions_features(self):
        ...
        for mention in self.mentions:
            #get_single_mention_features(mention)
    ...
    def get_single_mention_features(self, mention):
        ...
        #print('abc '+str(mention))
        #print('abc'+str(mention.features))
